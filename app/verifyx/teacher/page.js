...
export default function TeacherPage(){
 ...
 return <main className="vx-page"><div className="vx-wrap"><TeacherNav active="assignments"/>
  ...
  {show&&<section className="vx-card vx-create-panel"><p className="vx-kicker">NEW ASSIGNMENT</p><h2>สร้าง Assignment ใหม่</h2><form className="vx-form" onSubmit={create}>
   ...
   <div className="vx-form-row"><label>ระดับ<select name="difficulty" defaultValue="basic"><option value="basic">Basic</option><option value="pro">Pro</option><option value="advanced">Advanced</option></select></label><label>Subject สำหรับปรนัย<input name="subject" defaultValue="SolidWorks"/></label></div>
