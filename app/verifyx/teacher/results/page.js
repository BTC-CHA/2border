...
export default function ResultsPage(){
 ...
 async function load(){
  ...
  const [{data,error},{data:as,error:ae}]=await Promise.all([
   vx.rpc('vx_teacher_final_results_v3'),
