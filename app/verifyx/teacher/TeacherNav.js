...
export default function TeacherNav({active}){
  const items=[['assignments','/verifyx/teacher','Assignments'],['bank','/verifyx/teacher/question-bank','Question Bank'],['students','/verifyx/teacher/students','Students'],['results','/verifyx/teacher/results','Results'],['settings','/verifyx/teacher/settings','Settings']];
